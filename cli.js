...
module.exports = function (dir, options) {
    if (fs.existsSync(dir)) {
        validate.BIDS(dir, options, function (issues, summary) {
            ...
            if (issues === 'Invalid') {
                console.log(colors.red("The directory "dir" failed the Quick Test. This means the basic names and structure of the files and directories in not BIDS compliant. For more info go to http://bids.neuroimaging.io/"));
